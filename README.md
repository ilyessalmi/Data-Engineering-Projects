...
### [Projet 1 : Stratégie de Migration Cloud & FinOps](./01-Migration-Cloud-Architecture)
**Focus :** Architecture Azure, Estimation des coûts (TCO), Comparatif Cloud (Benchmark).
* Analyse d'une infrastructure On-Premise et proposition d'une architecture Cloud Native sur Azure avec analyse financière.*
